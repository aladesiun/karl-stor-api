...
<section style="background-color: white;padding: 20px" class="all-cont">
    ...
    <div class="summary">
        <div class="sum-details">
            ...
            <p>Thank you for trustinn us. Soon you will start getting orders as soon as customers start to order</p>
        </div>
    </div>
    <div class="more-info">
        <p>if you have any questions, contact us at <a href="http://localhost:8080">exodus.com</a></p>
    </div>
</section>
</body>
</html>
